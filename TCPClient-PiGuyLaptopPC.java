...
class TCPClient {
    public static void main(String argv[]) throws Exception {
        ...
        InetAddress nickIP = InetAddress.getByName("10.0.1.2"); //Gets my IP and stores it
        linkEstablished = nickIP.isReachable(500); //Checks if I can be connected to other PC
        ...
        Socket clientSocket = new Socket("PiGuyPC", 6789); //Uses IP to connect to my computer's server
        DataOutputStream outToServer = new DataOutputStream(clientSocket.getOutputStream());
        BufferedReader inFromServer = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
        String sentence = JOPI("What would you like to ask Nick?");
        outToServer.writeBytes(sentence + '\n');
        String modifiedSentence = inFromServer.readLine();
        System.out.println("Nick: " + modifiedSentence);
    }
